const Artifact = ({ title, subtitle, icon }) => {
  return (
    <div>
      <a
        href="#"
        target="_blank"
        rel="noreferrer"
        className="flex items-center justify-between rounded-2xl bg-gray-800 px-3 py-4 transition duration-300 hover:bg-gray-800/80"
      >
        ...
        <div className="flex flex-row items-center gap-7 sm:min-w-[14rem]">
          <div className="space-y-0.5 text-left sm:text-center min-[500px]:flex-grow min-[500px]:text-left">
            ...
            <div className="text-xs font-semibold text-[#53B5FF]">
              {subtitle}
            </div>
          </div>
        </div>
